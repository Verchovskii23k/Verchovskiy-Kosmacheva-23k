...
TRAIN_DATA_DIR = 'CatsDogs/train' # Путь к каталогу с обучающими данными
VALIDATION_DATA_DIR = 'CatsDogs/test' # Путь к каталогу с данными для валидации
TRAIN_SAMPLES = 1500 # Общее количество обучающих примеров
...
BATCH_SIZE = 3 # Размер пакета для обучения модели (количество образцов, обрабатываемых моделью за один шаг обучения)
